...
from train_teacher_model import Trainer, Validator
from extractor import Extractor
from utils import utils
from utils.visualize import save_image as save_image
...
def main():
    ...
    parser.add_argument('--cmd',default='test', type=str, choices=['train', 'test', 'extract'], help='train, test or extract')
    parser.add_argument('--arch_type', type=str, default='resnet50_ft', help='model type',
                        choices=['resnet50_ft', 'senet50_ft', 'resnet50_scratch', 'senet50_scratch','resnet152'])
    parser.add_argument('--dataset_dir', type=str, default='/media/hyo/文档/Dataset/vggface2/train', help='dataset directory')
    parser.add_argument('--log_file', type=str, default='./log_file', help='log file')
    parser.add_argument('--train_img_list_file', type=str, default='/media/hyo/文档/Dataset/vggface2/train_list.txt',
                        help='text file containing image files used for training')
    parser.add_argument('--test_img_list_file', type=str, default='/media/hyo/文档/Dataset/vggface2/train_list.txt',
                        help='text file containing image files used for validation, test or feature extraction')
    parser.add_argument('--meta_file', type=str, default='/media/hyo/文档/Dataset/vggface2/identity_meta.csv', help='meta file')
    ...
    parser.add_argument('--weight_file', type=str, default='./weight/weight.pkl', help='weight file')
    ...
    if 'resnet' in args.arch_type:
        model = ResNet.resnet152(num_classes=N_IDENTITY, include_top=include_top)
    # else:
